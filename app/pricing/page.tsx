    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-ink text-white px-6 py-16 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
            Whether you&apos;re a driver keeping your car in shape or a workshop growing your customer base — we have a plan for you.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-slate-900 mb-8">For drivers</h2>
            ...
            {consumerPlans.map((plan) => (
              ...
              >
                ...
                <div className="mt-2 flex items-baseline gap-1">
                  ...
                  {plan.highlighted && <span className="text-slate-500">/month</span>}
                </div>
